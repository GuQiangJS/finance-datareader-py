...
def get_dividends(symbol: str, retry_count=3, timeout=30, pause=None):
    ...
    :param timeout:
    :param pause:
    :return: 返回 [分红(`DataFrame`),配股(`DataFrame`)]
    ...
    配股
    ============  ==============   ============   ==========  ==========   ==========  ==========  ===========  =====================  ==========
      公告日期     募集资金合计(元)   基准股本(万股)   缴款终止日     缴款起始日   股权登记日   配股上市日    配股价格(元)  配股方案(每10股配股股数)   除权日
    ============  ==============   ============   ==========  ==========   ==========  ==========  ===========  =====================  ==========
      1994-12-24        NaN        115755000.0    1995-01-27  1995-01-16   1995-01-03  1995-02-22      8.0             2.0             1995-01-04
    ============  ==============   ============   ==========  ==========   ==========  ==========  ===========  =====================  ==========
